<?php
// $Id: listform.php,v 1.1 2006/03/10 17:15:55 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
/**
* @var	array	$lock defines values used to filter content ( hard to explain will example )
*/
$lock = array();


/**
* @var	int	$p defines the currently requested page
*/
$p = 1;
