<?php
// $Id: noahDbDiscovery.php,v 1.2 2006/03/19 20:04:36 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
	...
	class NoAhDbDiscovery extends NoAhPage
	{
		...
		*/
		...
		{
			$miss = array();
			$table_fields = NoAhDbDiscovery::listFields($table);
			//	print "<pre>";
		...
		{
			$table_list = NoAhDbDiscovery::listTables();
